    ...
    <div className="grid grid-cols-2 gap-5">
      <div className="rounded  shadow p-5 border">
        <div className="flex items-center justify-between">
          ...
          <div className="font-bold text-[#292E1E]">
            <p className="text-lg text-green-500 text-end">$60000 PA</p>
        ...
        <div className="">
          <p className="text-justify text-sm my-10">
      ...
      <div className="p-5 rounded shadow border">
        <div className="flex items-center justify-between">
          ...
          <div>
            <p className="text-green-500 text-end font-bold text-lg">
              $40000 PA
            </p>
      ...
      <div className="p-5 shadow rounded border">
        <div className="flex items-center justify-between">
          ...
          <div className="font-bold text-[#292E1E] justify-between">
            <p className="text-green-500 text-end text-lg">$60000 PA</p>
